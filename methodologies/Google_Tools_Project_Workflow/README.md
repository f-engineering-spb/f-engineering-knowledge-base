...
- без цветного оформления обычных рабочих таблиц;
...
Для Excel и Google Sheets по умолчанию использовать простую черно-белую стилистику: белые ячейки, черный текст, тонкие границы, жирный текст в строке заголовков. Не применять черные или темные шапки таблиц с белым текстом, цветные плашки и декоративные заливки. Цвет допускается только как осмысленная служебная отметка: ошибка, просрочка, предупреждение, статус или ручной контроль.
