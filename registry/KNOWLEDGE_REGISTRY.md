...
| DS-010 | `docs/F_ENGINEERING_VISUAL_STYLE.md` | Style | Стандарты документов | Светлый визуальный стандарт выдаваемых документов и материалов | Для таблиц, документов, презентаций, отчетов, КП и светлых HTML-документов | Approved |
| DS-011 | `docs/F_ENGINEERING_DIGITAL_PRODUCT_STYLE.md` | Style | Цифровые продукты | Машинный IDE-стиль продуктовых интерфейсов и служебных интерактивных артефактов | Для лаунчеров, панелей, навигаторов, просмотрщиков и служебных Markdown-продуктов | Candidate |
| PRD-001 | `products/f-engineering-launcher/` | Tool | Продуктовая платформа | Диалоговая оболочка выбора, запуска и контроля бизнес-модулей | Когда нужно запускать повторяемые модули из папки объекта через единое окно | Candidate |
